...
public class OrdersPanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        */
        ...
        setSize(new java.awt.Dimension(416, 149));
    ...
    private void btnokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnokActionPerformed
        OrdersPdf fees=new OrdersPdf();
        fees.OrdersPdf(con, String.valueOf(txtid.getText()));
        this.dispose();
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        if(jTextField1131.getCaretPosition()>2){
            ...
            jSearchTable21.setModel(TableModel.createTableVectors(con, "select distinct(order_id) from stock_orders where order_id ilike '%"+jTextField1131.getText()+"%' "));
            jSearchScrollPane21.setViewportView(jSearchTable21);
