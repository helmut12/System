...
//            refDocString = "";
        ...
        wagwaan.config.XmlSerializer xmlSerializer = new wagwaan.config.XmlSerializer(tableName2Export, xmlOutputStream, refDocString, exportTableName);
...
//            htmlDocument.open();
            ...
            SAXParser pdfParser = SAXParserFactory.newInstance().newSAXParser();
