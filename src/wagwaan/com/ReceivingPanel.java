...
private final Connection con;
    ...
    private void btnokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnokActionPerformed
        StocksReceivingPdf fees=new StocksReceivingPdf();
        fees.StocksReceivingPdf(con, String.valueOf(txtid.getText()));
        this.dispose();
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        if(jTextField1131.getCaretPosition()>2){
            ...
            jSearchTable21.setModel(TableModel.createTableVectors(con, "select distinct(receiving_no) from st_receiving_issuing where receiving_no ilike '%"+jTextField1131.getText()+"%' "));
            jSearchScrollPane21.setViewportView(jSearchTable21);
