 ...
 * @author Helmut
 */
public class PaidUpvsExpectedPerItmPerTermDlg extends javax.swing.JDialog {
Connection con;
    /**
    ...
    private void initComponents() {
        ...
        */
        ...
        setSize(new java.awt.Dimension(373, 228));
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(jComboBox1.getSelectedItem().equals("-") || jComboBox1.getSelectedItem().equals(null)){
            JOptionPane.showMessageDialog(this, "Please select the Class from the topmost comboBox", "Missing Variables!!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        
        if(jTextField1132.getCaretPosition()>2){
            jSearchTable22.setModel(TableModel.createTableVectors(con, "SELECT distinct(term), class  FROM fees_setup "
                    + "where term ilike '"+jTextField1132.getText()+"' and class='"+jComboBox1.getSelectedItem()+"' "));
            jSearchScrollPane22.setViewportView(jSearchTable22);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        wagwaan.reports.PaidUpvsExpectedPerItmPerTermPdf paid=new wagwaan.reports.PaidUpvsExpectedPerItmPerTermPdf();
        paid.PaidUpvsExpectedPerItmPerTermPdf(con, String.valueOf(jComboBox1.getSelectedItem()), String.valueOf(jTextField1.getText()));
        this.dispose();
