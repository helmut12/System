 ...
 * @author Helmut
 */
public class FeesBalancePerClassPdf implements java.lang.Runnable{
/*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 ...
 **/
    ...
    public void FeesBalancePerTermPdf(java.sql.Connection connDb,  String term, String classes) {
        this.term_id=term;
...
//                        docPdf.setHeader(headerFoter);
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Fees Balance Per class - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        phrase=new Phrase("Students with Fees Balance for CLASS: "+term_id+",  TERM: "+class_id);
                        ...
                        phrase = new Phrase("Payables",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select  r.student_id,  r.first_name||' '||middle_name||' '||last_name as names, payables, sum(debit), sum(credit),  "
                                    + "sum(credit)-sum(debit) balance from fees_ledger l, student_registration r where current_term='"+class_id+"' and current_class='"+term_id+"' "
                                    + "and credit-debit>0 and r.student_id=l.student_id group by 1, 2, 3 order by 1 desc");
                             int count=1;
                            while (rset.next()) {
